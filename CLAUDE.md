...
- 280–284 jUnit, atualizando JDK, Record Class, Pattern Matching for instanceof (fim do curso; README lista 284 aulas)
...
Se o vídeo não tiver legenda nenhuma (ex.: aulas 206, 213, 216 e 243), o script falha nas 3 tentativas: peça ao autor um resumo do vídeo e use com o código do professor, avisando na página.
...
Faltam algumas branches (ex.: não existem `video106`, `video219`, `video252` e `video254`); nesse caso, diff a partir da anterior que existir (`video105..video107`).
